						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="admin/IMG/<?php echo $row_s['pro_img1']; ?>" alt="" class="pro-image-front">
									<img src="admin/IMG/<?php echo $row_s['pro_img1']; ?>" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.php?id=<?php echo $row_s['pro_no']; ?>" class="link-product-add-cart add fontlaos">ກົດເບິ່ງ</a>
											</div>
										</div>
								...
								<div class="item-info-product ">
									<h4 class="laofont"><a href="single.php?id=<?php echo $row_s['pro_no']; ?>"><?php echo $row_s['pro_name']; ?></a></h4>
									<div class="info-product-price">
										<span class="item_price"><?php echo number_format($row_s['pro_price']); ?> kip</span>
									</div>
									<a href="single.php?id=<?php echo $row_s['pro_no']; ?>" class="item_add single-item hvr-outline-out button2 fontlaos">ເພີ່ມໄປທີ່ກະຕ່າ</a>									
								</div>
							</div>
						</div>
		...
		<?php }else{ ?>
			...
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					...
					<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span  class="fontlaos">ສິນຄ້າສຳລັບທ່ານຊາຍ</span></li> 
					<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span  class="fontlaos">ສິນຄ້າສຳລັບທ່ານຍິງ</span></li> 
				</ul>				  	 
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<?php 
							 ...
							 ?>
						<div class="col-md-3 product-men">
							<img class="product-new-top" src="admin/imgdiscount/<?php echo $row['pro_discount']; ?>.png" style="background: none; width: 60%; height: 20%; margin-right:-10px;
							margin-top:-20px; ">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<img src="admin/IMG/<?php echo $row['pro_img1']; ?>" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.php?id=<?php echo $row['pro_no']; ?>" class="link-product-add-cart fontlaos">ກົດເບິ່ງ</a>
											</div>
										</div>
