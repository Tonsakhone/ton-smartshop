		...
		<h3 class="fontlaos">ສິນຄ້າທີ່ມີສ່ວນຫຼຸດ</h3>
					...
					<?php 
						...
						<div class="col-md-3 product-men">
							<img class="product-new-top" src="admin/imgdiscount/<?php echo $row['pro_discount']; ?>.png" style="background: none; width: 60%; height: 20%; margin-right:-10px; margin-top:-20px; ">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
										<span class="item_price"><?php echo $sale; ?> kip</span>
										<del><?php echo $row['pro_price']; ?></del>
									</div>
